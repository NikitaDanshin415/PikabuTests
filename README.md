...
Для запуска тестов локально используется команда : gradle clean parallelRegress

<p>-DforkCount - количество потоков для запуска теста</p>
<p>-Dbrowser - браузер для запуска теста</p>

Для работы тестов подразумевающих авторизацию в системе нужно дополнительно указать параметры:
<p>-Dlogin - логин для Pikabu</p>
<p>-Dpassword- пароль для Pikabu</p>
Либо прописать их в конфигурационном файле "resources/config/userConfig.properties"
